...
/*
    ...
    public ModelAndView partlist() {
        return new ModelAndView("/admin/partlist");
    }

    //管理员注销
    @RequestMapping("/outAdmin")
    public String outAdmin(HttpSession session, HttpServletRequest request, HttpServletResponse response, SessionStatus sessionStatus) throws Exception{
    ...
    public ModelAndView dashboard() {
        Map<String, Object> map = new HashMap<String, Object>();
        int stu_total = userService.countStu();
        int com_total = userService.countCompany();
        int resume_total = companyService.resumeCount();
        int apply_total = companyService.countApply();

        map.put("s_total",stu_total);
        map.put("c_total",com_total);
        map.put("r_total",resume_total);
        map.put("a_total",apply_total);
        return new ModelAndView("/admin/dashboard",map);
    }
}
