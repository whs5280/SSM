...
public class CompanyController {
    ...
    /*@RequestMapping(value = "/allResume")
    @ResponseBody
    public Map<String,Object> listResume(Resume resume,Integer pageNum,Integer pageSize) throws Exception{
        Map<String,Object> map = new HashMap<String,Object>();
        try{
            //获取分页信息
            ...
            PageInfo<Resume> page = companyService.pageResume(resume, pageNum, pageSize);
            map.put("page", page);
        }catch (Exception e){
            throw new CustomException("未知错误");
        }
    ...
    //通过城市获取兼职
    @RequestMapping(value = "/findResumeByCity")
    @ResponseBody
    public Map<String,Object> findResumeCity(String department) throws Exception{
        Map<String ,Object> map = new HashMap<String,Object>();
        try{
            System.out.println(department);
            List<Resume> reList = companyService.findResumeCity(department);
