...
public class CompanyServiceImp implements CompanyService{
    ...
    //获取所有有效兼职信息  分页
    public PageInfo<Resume> pageResume(Resume resume, Integer pageNum, Integer pageSize){
        PageInfo<Resume> page = null;

        PageHelper.startPage(pageNum, pageSize);
        List<Resume> list = cdao.allResume();
        page = new PageInfo<Resume>(list);
        return page;
    }
    ...
    //通过城市获取兼职
    public List<Resume> findResumeCity(String department){
        List<Resume> list = cdao.findResumeCity(department);
        return list;
    }
 ...
 //下线兼职
    ...
    public int resumeCount() {
        return cdao.resumeCount();
    }

    //统计匹配成功信息
    public int countApply() {
        return cdao.countApply();
    }
