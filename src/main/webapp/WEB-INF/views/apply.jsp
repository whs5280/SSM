...
<head>
    ...
    <title>${resume.jobName}-大学生兼职平台</title>
    ...
    <script type="text/javascript">
        ...
        function mycollect(){
            ...
            $.ajax({
                type: "get",
                url: "addCollect",
                data: {"stuEmail": email, "resumeId": id},
                dataType: "json",
                success: function (response) {
                    alert('收藏成功')
    ...
    <div id="header">
        <div class="wrapper">
            <a class="logo" href="index">
                <img width="229" height="43" alt="拉勾招聘-专注互联网招聘" src="style/images/logo5.png">
            </a>
            ...
            <div class="content_l">
                <dl class="job_detail">
                    ...
                    <dd class="resume resume_web">
                        ...
                        <span class="setBtns">
				                        	<a target="_blank" title="预览"
                                               href="preview?email=${sessionScope.email}">预览</a> |
