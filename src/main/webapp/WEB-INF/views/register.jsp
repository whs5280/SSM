...
<body id="login_bg">
	<div class="login_wrapper">
		<div class="login_header">
			<a href="h/"><img src="style/images/logo_whs.png" width="285" height="62" alt="拉勾招聘" /></a>
		...
		<div class="login_box">
        	<form id="loginForm">
            	...
            	<label class="fl registerJianJu" for="checkbox">
            		<input type="checkbox" id="checkbox" name="checkbox" checked  class="checkbox valid" />我已阅读并同意<a href="" target="_blank">《用户协议》</a>
           		</label>
	    	 ...
	    	 $("#loginForm").validate({
			    	...
			    	messages: {
			    		type:{
			    	 	...
			    	 	email: {
			    	    	required: "请输入常用邮箱地址",
			    	    	email: "请输入有效的邮箱地址，如：whs@lagou.com"
			    	   	},
			    	   	password: {
			    	    	required: "请输入密码",
