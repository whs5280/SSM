    ...
    <div id="header">
        <div class="wrapper">
            <a class="logo" href="index">
                <img width="229" height="43" alt="大学生兼职平台-公司主页" src="style/images/logo6.png">
            </a>
                ...
                <div id="Na">
                    <div class="na_wrap">
                        ...
                        <dl class="c_section newName dn" style="display: none;">
                            ...
                            <dd>
                                <form id="NameForm">
                                    <input type="text" placeholder="请输入公司名称" value="" id="companyname"
                                           name="companyname">
                ...
                <div id="Tags">
                    <div id="c_tags_show" class="c_tags solveWrap" style="display: block;">
                        <table>
                            ...
                            <tr>
                                <td>领域</td>
                                <td id="select_industry_hidden"></td>
                            </tr>
                            <tr>
                                <td>规模</td>
                                <td id="select_scale_hidden"></td>
                            </tr>
                            <tr>
                                <td>主页</td>
                                <td id="website"></td>
                        ...
                        <form id="tagForms">
                            <table>
                                ...
                                <tr>
                                    <td>地点</td>
                                    <td>
                                        <input type="text" placeholder="请输入地点" value="" name="city" id="c"
                                               class="valid">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>规模</td>
                                    <td>
                                        <input type="hidden" value="少于15人" id="companySize" name="companySize"
                                               class="valid">
                                ...
                                <tr>
                                    <td>主页</td>
                                    <td>
                                        <input type="text" placeholder="请输入网址" value="" name="companyUrl"
                                               id="companyUrl" class="valid">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
