...
<div id="body">
    ...
    <div id="container">
        ...
        <div class="sidebar">
            <a class="btn_create" id="btn_create" onclick="create()">发布勤工助学</a>
        ...
        <div class="content" id="createIndex">
            <dl class="company_center_content">
                <dt><h1><em></em>发布</h1></dt>
                <dd>
                    <div style="width: 90%;">

                        <form id="picForm" action="upload" enctype="multipart/form-data" method="post">

                            <input name="comEmail" hidden="hidden" value="${sessionScope.email}">
                            <textarea placeholder="请加入描述" name="mark" id="mark" style="width: 400px;height: 300px;margin-left: 50px;"></textarea>
                            <div class="new_portrait">
                                <div class="portrait_upload" id="portraitNo">
                                    <span>上传照片</span>
                                </div>
                                <input type="file" value="" title="支持jpg、jpeg、gif、png格式，文件小于5M" name="pic" id="pic" class="myfiles">
                            ...
                            <div class="clear"></div>
                            <input type="submit" value="发布" id="submitProfile" class="btn_small" style="margin-left: 50px;">
                        </form>
                    </div>
                </dd>
            </dl>
        ...
        <div class="content dn" id="unmanage">
            <dl class="company_center_content">
                <dt><h1><em></em>待处理 <span id="dcl"></span></h1></dt>
                <dd>
        ...
        <div class="content dn" id="pass">
            <dl class="company_center_content">
                <dt><h1><em></em>已通过 <span id="tg"></span></h1></dt>
                <dd>
                    <form action="haveRefuseResumes.html" method="get" id="filterForm">
        ...
        <div class="content dn" id="unpass">
            <dl class="company_center_content">
                <dt><h1><em></em>未通过 <span id="btg"></span></h1></dt>
                <dd>
                    <form action="haveRefuseResumes.html" method="get" id="filterForm">
