...
<div id="body">
    <div id="header">
        <div class="wrapper">
            <a class="logo" href="comIndex">
                <img width="229" height="43" alt="大学生兼职平台-发布兼职" src="style/images/logo6.png">
            </a>
            <ul id="navheader" class="reset">
                <li><a href="index">首页</a></li>
                <li><a rel="nofollow" href="comIndex">公司信息</a></li>
                <li><a rel="nofollow" href="picIndex">勤学助工</a></li>
            </ul>
    ...
    <div id="container">
        ...
        <div class="content dn" id="unmanage">
            <dl class="company_center_content">
                <dt><h1><em></em>待处理简历 <span id="dcl"></span></h1></dt>
                <dd>
        ...
        <div class="content dn" id="pass">
            <dl class="company_center_content">
                <dt><h1><em></em>通过简历 <span id="tg"></span></h1></dt>
                <dd>
                    <form action="haveRefuseResumes.html" method="get" id="filterForm">
        ...
        <div class="content dn" id="unpass">
            <dl class="company_center_content">
                <dt><h1><em></em>未通过简历 <span id="btg"></span></h1></dt>
                <dd>
                    <form action="haveRefuseResumes.html" method="get" id="filterForm">
        ...
        <div class="content dn" id="complete">
            <dl class="company_center_content">
                <dt><h1><em></em>已完成 <span id="comNum"></span></h1></dt>
                <dd>
                    <form action="haveRefuseResumes.html" method="get" id="filterForm">
        ...
        <div class="content dn" id="valid">
            <dl class="company_center_content">
                <dt><h1><em></em>有效职位 <span>（共<i style="color:#fff;font-style:normal" id="positionNumber"></i>个）</span>
                </h1></dt>
                <dd>
        ...
        <div class="content dn" id="allAllege">
            <dl class="company_center_content">
                <dt><h1><em></em>我的申述 <span>（共<i style="color:#fff;font-style:normal" id="allegeNumber"></i>个）</span>
                </h1></dt>
                <dd>
        ...
        <div class="content dn" id="unvalid">
            <dl class="company_center_content">
                <dt><h1><em></em>已下线职位 <span>（共<i style="color:#fff;font-style:normal"
                                                  id="positionNumber1"></i>个）</span></h1></dt>
                <dd>
                            ...
                            <tr id="kkk">
                                ...
                                <td>
                                    ...
                                    <input type="button" value="请选择兼职类型" id="select_category"
                                           class="selectr selectr_380" name="select_category"> <input type="hidden"
                                                                                                      id="positionType"
                                                                                                      value=""
                                                                                                      name="positionType">
                                ...
                                <div class="cont">
                                    ...
                                    <div id="doPoint">
                                        ...
                                        <table cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <th>工作态度：</th>
                                                <td><span class="star5" id="item1" v="5"><small>1</small><small>2</small><small>3</small><small>4</small><small>5</small><small>6</small><small>7</small><small>8</small><small>9</small><small>10</small></span>
                                                </td>
                                                <td><strong>5</strong> <em>(合格)</em></td>
                                            </tr>
                                            <tr>
                                                <th>工作效率：</th>
                                                <td><span class="star5" id="item2" v="5"><small>1</small><small>2</small><small>3</small><small>4</small><small>5</small><small>6</small><small>7</small><small>8</small><small>9</small><small>10</small></span>
                                                </td>
                                                <td><strong>5</strong> <em>(合格)</em></td>
                                            </tr>
                                            <tr>
                                                <th>完成情况：</th>
                                                <td><span class="star5" id="item3" v="5"><small>1</small><small>2</small><small>3</small><small>4</small><small>5</small><small>6</small><small>7</small><small>8</small><small>9</small><small>10</small></span>
                                                </td>
                                                <td><strong>5</strong> <em>(合格)</em></td>
                                            </tr>
                                            </tbody>
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" role="form">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <textarea class="form-control" rows="1" placeholder="请输入申述原因" id="stuAllege"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <textarea class="form-control" rows="3" placeholder="请输入详细描述"
                                                      id="stuAllegeText" style="width:465px;font-size:15px"></textarea>
                                            <span class="error" style="display:none;margin-left:100px;"
                                                  id="beError1"></span>
                                        </div>
                                    </div>
